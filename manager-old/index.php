...
checkExistUser($dataUser['isUser']);
$affiliates = getAffiliates($dataUser['affiliate']);
    ...
    <div data-v-11941ac8="" id="app">
        <div data-v-11941ac8="">
            <div class="wapper bg-profile"
                 style="background-image: url(https://app.vipcard.biz/image/backgourd/backgroud-web.jpg);">
                <div data-v-3eebf978=""><!---->
                                ...
                                <div data-v-3eebf978="" class="web">
                                    <div data-v-3eebf978="" class="container-btn"><!----><!----><!---->
                                        ...
                                        <button data-v-3eebf978="" class="btn-call"><img data-v-3eebf978="" src="data:image/png;base64," alt="phone">
                                            <span data-v-3eebf978=""><a data-v-3eebf978="" href="tel:<?=$dataUser['sdt']?>">Gọi điện</a></span>
                                        </button>
                                        <div data-v-3eebf978="" class="save save-to-phone"><img data-v-3eebf978="" src="data:image/png;base64," alt="book">
                                            <a class="save-to-phone" data-v-3eebf978="" href="https://app.vipcard.biz/Dao_Toan.vcf" >Lưu danh bạ</a>
                ...
                <div style="min-height: 600px;">
                    <div>
                            ...
                            <div data-v-ab9b8fc2="" id="wapper2" class="wapper">
                                ...
                                <div data-v-ab9b8fc2="" class="info_block">
                                    <div data-v-ab9b8fc2="" class="avatar_image">
                                        <img data-v-ab9b8fc2="" src="https://vipcard.biz/pub/media/avatar/tmp/image/<?=$dataUser['link_avatar']?>" alt="">
                                    </div>
                                ...
                                <div data-v-5b7a91ea="" class="container-btn">
                                    <button data-v-5b7a91ea="">
                                        ...
                                        <span data-v-5b7a91ea="">
                                            <a data-v-5b7a91ea="" href="tel:<?=$dataUser['sdt']?>">Gọi điện</a>
                                        </span>
                                    </button>
                                    <div data-v-5b7a91ea="">
                                        <img data-v-5b7a91ea=""
                                        ...
                                        <a data-v-5b7a91ea=""
                                           href="blob:https://app.vipcard.biz/Dao_Toan.vcf"
                                           download="contact.vcf">Lưu danh bạ</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php
                                ...
                                <?php
                                    $isBank = 0;
                                    if($affiliate['affiliate_id'] == 'nganhang'){
                                        $isBank = 1;
                                        $fieldBank ++ ;
                                        $bankInfo = explode("|", $affiliate['affiliate']);
                                ?>
                                ...
                                <?php }?>
                            <div class="item item-tag click_affiliate" modal="<?=$fieldBank?>" app="<?=strtolower($affiliate['affiliate_id'])?>" affiliateID="<?=$affiliate['affiliate']?>" link_affiliate="<?=$affiliate['link_affiliate']?>">
                                <img class="item-tag-img"
                                     src="https://app.vipcard.biz/image/affiliate-templates/<?=$affiliate['link_icon']?>"
                                     alt="logo" width="34">
                                <span> <?php
                                    if(!$isBank)
                                        echo $affiliate['name_affiliate'];
                                    else
                                        echo $bankInfo[0]
                                    ?></span>
                            </div>
                ...
                <div data-v-3c45ac26="" class="wapper"><img data-v-3c45ac26="" src="/img/logo_header2.5fe51258.png"
                                                            alt="logo" class="logo"><span data-v-3c45ac26="">THẺ CÁ NHÂN THÔNG MINH</span>
                </div>
            </div>
        </div>
    </div>
