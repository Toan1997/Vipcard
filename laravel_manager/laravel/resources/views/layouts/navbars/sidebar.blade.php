...
if(strtotime($dateNow)  > strtotime($addingDate))
    $status = '<p style="color: indianred;font-weight: 600;">Expires</p>';
else
    $status = $addingDate;
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="navbar-examples">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('user.info',['id' => getBase64Encode($userId)]) }}">
                                    {{ __('User Profile') }}
                                </a>
                            </li>
        ...
        @if(!$isActive)
            ...
            <div class="card card-plain shadow-none" id="sidenavCard">
                ...
                <div class="card-body text-center p-3 w-100 pt-0">
                    <div class="docs-info">
                        <p class="text-xs font-weight-bold mb-0">Trial version to</p>
                        {{$status}}
                    </div>
                </div>
            </div>
            <a class="btn btn-primary btn-sm mb-0 w-100" href="#" type="button">Buy now</a>
        </div>
        @endif
    </div>
</nav>
